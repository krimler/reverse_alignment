...
cross-dimensional structure. The goal is to illustrate when learned models outperform rule-based systems.
...
problem in ideal case, and does not indicate practical case.
